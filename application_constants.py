...
BSKY_USERNAME = 'ballplayerbot.bsky.social'
...
#URL strings for bbref
BBREF_BASE_URL = r'https://www.baseball-reference.com'
BBREF_BASE_PLAYERS_URL = r'https://www.baseball-reference.com/players/'
